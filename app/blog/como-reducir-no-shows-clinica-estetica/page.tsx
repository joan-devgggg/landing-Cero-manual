...
const DESCRIPTION =
  "Un no-show en tu clínica estética es un hueco que ya no se llena. Te explicamos cómo reducirlos con recordatorios automáticos. Pide tu diagnóstico gratuito."
