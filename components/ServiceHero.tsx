...
export interface ServiceHeroProps {
  label: string
  /** Líneas del H1. La última línea puede llevar un tramo en cursiva sage usando `accent`. */
  headlineLines: string[]
  /** Tramo final en cursiva sage que se añade a la última línea del headline. */
  accent?: string
  subheadline: string
  metrics: ServiceHeroMetric[]
}

export default function ServiceHero({ label, headlineLines, accent, subheadline, metrics }: ServiceHeroProps) {
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl lg:text-7xl font-semibold leading-[1.1] tracking-tight mb-8"
        ...
        >
          ...
          {accent && (
            <span style={{ color: "#7D9B76", fontStyle: "italic" }}> {accent}</span>
          )}
        </motion.h1>
